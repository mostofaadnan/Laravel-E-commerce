...
<div class="col-lg-12">
    <div class="card mainpanel">
        <div class="card-header card-header-section">
            <div class="pull-left">
                @lang('home.term') @lang('home.&') @lang('home.condition') @lang('home.management')
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <div class="card">
                        <div class="card-header card-header-section">
                            @lang('home.new') @lang('home.term') @lang('home.&') @lang('home.condition')
                        </div>
                        <div class="card-body">
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header card-header-section">
                            <div class="pull-left">
                                @lang('home.term') @lang('home.&') @lang('home.condition') @lang('home.list')
                            </div>
                        </div>
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ url('Admin/TermCondition/delete')}}" + '/' + dataid,
                        success: function(data) {
                            table.ajax.reload();
                            clear();
                        },
