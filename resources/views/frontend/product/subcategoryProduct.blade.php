            ...
            <div class="col-12">
                <div class="breadcrumb_content">
                    <ul>
                        ...
                        <li><a href="{{ route('product.categoryproduct',$subcategory->Categoryname) }}">{{ $subcategory->Categoryname->title }}</a></li>
                        ...
                        <div class="single_product">
                            <div class="product_thumb">
                                ...
                                <div class="action_links">
                                    <ul>
                                        <li class="wishlist"><a href="{{ route('wishlist.addToWish',$product->id)}}" title="Add to Wishlist"><i class="icon-heart"></i></a></li>
