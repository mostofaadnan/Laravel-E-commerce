...
<script type='text/javascript'>
    ...
    function DataTable() {
        table = $('#mytable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('homecategory.loadall') }}",
                "type": "GET",
            },
            columns: [{
                    data: 'DT_RowIndex',
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ url('Admin/Home-Category/delete')}}" + '/' + dataid,
