...
<div class="col-lg-12">
    <div class="card mainpanel">
        <div class="card-header card-header-section">
            <div class="pull-left">
                @lang('home.product') @lang('home.slide') @lang('home.management')
            </div>
        </div>
        <div class="card-body">
            <div class="row">
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ url('Admin/Product-Slide/delete')}}" + '/' + id,
