...
<div class="card col-sm-10">
    ...
    <div class="card-body image-body">
        <div class="main-img-preview">
            <img class="thumbnail img-preview" id="img-upload" src="{{asset('assets/images/avater/avater.jpg')}}" style="width:200px; height: 200px" name="image" class="img-thumbnail" title="Preview Logo">
        </div>
    </div>
