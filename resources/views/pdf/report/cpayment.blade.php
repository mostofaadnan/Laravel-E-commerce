                ...
                <table class="table table-striped" style="width:100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right" width="12%">{{ $pd->recieve  }}</td>
                            <td align="right" width="12%">{{ $pd->balancedue  }}</td>
                            <td align="right" width="8%">{{ $payment  }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td align="right"><b>{{ $data['details']->sum('recieve') }}</b></td>
