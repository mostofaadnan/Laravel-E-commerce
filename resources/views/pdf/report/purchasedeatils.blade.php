                ...
                <table class="table table-striped" style="width:100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="10%" align="center">{{ $pd->purchasename->inputdate }}</td>
                            <td width="10%" align="center">{{ $pd->purchasename->purchasecode }}</td>
                            <td>{{ $pd->purchasename->SupplierName->name }}</td>
                            <td>{{ $pd->productName->name }}</td>
                            <td width="5%" align="right">{{ $pd->tp }}</td>
