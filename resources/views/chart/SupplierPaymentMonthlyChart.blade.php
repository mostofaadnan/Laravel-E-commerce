...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <div class="pull-left">
            @lang('home.supplier') @lang('home.payment') @lang('home.chart')
        </div>
    ...
    <div class="card-body">
        <div class="col-sm-12 col-md-12">
            {!! $SupplierPaymentMonthlyChart->container() !!}
        </div>
    </div>


</div>
{!! $SupplierPaymentMonthlyChart->script() !!}
<script>
    $("#viewchart").change(function(){
var type=$(this).val();
if(type==2){
    url = "{{ route('chart.supplieyPaymentYearlyView')}}",
      window.location = url;
}
    });
    var invoice_api_url = {{$SupplierPaymentMonthlyChart->id}}_api_url;
    ...
    function ChartFileter() {
        ...
        var month = $(".monthchart").val(); 
         {{$SupplierPaymentMonthlyChart->id}}_refresh(invoice_api_url + "?year=" + year + "&type=" + type+"&month="+month);
    }
</script>
@endsection