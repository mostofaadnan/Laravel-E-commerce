...
<div class="col-lg-12">
    <ul class="nav nav-tabs mb-2" id="myTabs" role="tablist">
        <li class="nav-item waves-effect waves-light searchnuv">
            <a class="nav-link navsearch active" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="true">@lang('home.order')</a>
        </li>
        <li class="nav-item waves-effect waves-light searchnuv">
...
@include('order.partials.invcreatescript')
