<script type="text/javascript">
        ...
        swal("Successfully Data Save", "Data Submit", "success", {
            ...
            .then((value) => {
                switch (value) {
                    ...
                    case "Show":
                        url = "{{ url('Admin/Order/show')}}" + '/' + data,
                            window.open(url, '_blank');
                        break;
                    case "catch":

                        url = "{{ url('Admin/Order/LoadPrintslip')}}" + '/' + data,
                            window.open(url, '_blank');
                        break;
                    case "datapdf":
                        url = "{{ url('Admin/Order/invoicepdf')}}" + '/' + data,
                            window.open(url, '_blank');
                        break;
    ...
    function InvSlip() {
        $.ajax({
            type: "get",
            url: "{{ url('Admin/Order/getView')}}" + '/' + invid,
            datatype: ("json"),
            success: function(data) {
                lodDatainv(data);
                printSlip();
