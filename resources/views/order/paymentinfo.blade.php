...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <div class="pull-left">
            @lang('home.payment') @lang('home.information')
        </div>
    </div>
    <div class="card-body">
        <div class="row  mt-2">
        ...
        <table id="mytable" class="table table-bordered" style="width:100%" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th> @lang('home.transectionid') </th>
                    <th> @lang('home.date') </th>
                    <th> @lang('home.cardtype')</th>
                    <th> @lang('home.amount') </th>
                    <th> @lang('home.storeamount')</th>
...
/*       var fromdate = $("#min").val();
      ...
      table = $('#mytable').DataTable({
        ...
        "ajax": {
          "url": "{{ route('order.paymentinfoload') }}",
          "type": "GET",
        },
