...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <h5 style="color:#fff;">@lang("home.order")</h5>
    </div>
    <div class="card-body">
        ...
        <table id="mytable" class="table table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="15%"> @lang('home.order') @lang('home.number') </th>
...
<script>
    ...
    function pdf(printconfirm) {
        ...
        if (tbody.children().length == 0) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('report.OrderQueryPdf') }}",
                ...
                datatype: ("json"),
                success: function(data) {
                    url = "{{ url('Admin/Report/OrderPdfView')}}",
